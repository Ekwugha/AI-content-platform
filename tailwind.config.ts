  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom brand colors inspired by African aesthetics
        amber: {
          50: "#fffbeb",
          100: "#fef3c7",
          200: "#fde68a",
      ...
      animation: {
        ...
        "thinking-dots": "thinking-dots 1.4s ease-in-out infinite both",
      ...
      backgroundImage: {
        ...
        "ambient-light": "radial-gradient(ellipse at top, var(--tw-gradient-stops))",
        "mesh-gradient": `
